...
public class ViewTest{
	...
	public void testPagination() throws Exception{
		...
		View v = InventoryView.createPaginated("Test View",components,1,new ItemStack(pageChangerType),new ItemStack(pageChangerType));
		int page = 0;
		while(true){
			int index = v.size() - 1;
	...
	private static class MockViewManager implements ViewManager{
...
//			System.out.println("history is empty, closing.");
	...
	private static class MockPlayer implements Player{
		...
		@Override
		public org.bukkit.inventory.InventoryView openInventory(Inventory inventory){
			return null;
		}

		@Override
		public org.bukkit.inventory.InventoryView openWorkbench(Location location,boolean force){
			return null;
		}

		@Override
		public org.bukkit.inventory.InventoryView openEnchanting(Location location,boolean force){
			return null;
		}
		...
		@Override
		public org.bukkit.inventory.InventoryView openMerchant(Villager trader,boolean force){
			return null;
		}
