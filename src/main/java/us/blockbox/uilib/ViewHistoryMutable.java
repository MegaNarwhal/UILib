...
public interface ViewHistoryMutable extends ViewHistory{
	...
	/**
	 * Overwrites the {@link View} at the head of this ViewHistory. This does not affect what the viewer sees.
	 * @param view The new current {@link View}
	 * @return The {@link View} that was at the head of this ViewHistory
	 */
